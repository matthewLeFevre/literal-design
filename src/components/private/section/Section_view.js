...
class SectionView extends Component {
  ...
  saveSection() {
    ...
    .then(res => {
      if(res.status === 'success') {
        updateState('currentSection', res.data);
        this.setState({
          section: res.data,
          edit: false,
        });
  ...
  render() {
    ...
    return(
      <div className="col--12 grid--nested--sml">
        <BreadCrumbs location={this.props.match}/>
        <OptionsPanel optionTitle="Section" location={this.props.match} />
...
SectionView.contextType = AppContext;
